  ...
  const templates = [
    {
        id: "classic",
        name: "Classic",
        preview: "A clean, traditional format with clear section and professional typography"
    },
    {
        id: "modern",
        name: "Modern",
    ...
    <div className='relative'>
        <button onClick={()=> setisOpen(!isOpen)} className='flex items-center gap-1 text-sm text-blue-600 bg-gradient-to-br from-blue-50 to-blue-100 ring-blue-300 transition-all px-3 py-2 rounded-lg'>
