    ...
    <div className='space-y-4'>
        <div className='flex items-center justify-between'>
                <div>
                    ...
                    <p className='text-sm text-gray-500'>Add summary for your resume here
                    </p>
                </div>
        ...
        <div className='mt-6'>
            ...
            <p>Tip: Keep it concise (3-4 sentences) and focus on your most relevant achivements and skills.</p>
